...
//blur event when text area goes out of focus
...
$(".list-group").on("click", "span", function () {
  ...
  dateInput.datepicker({
    minDate: 1,
    onClose: function () {
      //when calendar closes, force a 'change' event on the 'dateInput'
      $(this).trigger("change");
    },
  });
...
//use jQueryUI to drag tasks to new lists
...
//date-picker added to modal field
...
//set interval to check on any updated info every 30 min.
